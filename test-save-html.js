...
co        console.log('- Shows "3/3 conditions met":', htmlContent.includes('3/3 conditions met') ? '✅ YES' : '❌ NO');st EmailService = require('./src/services/email.service');
const fs = require('fs');
...
async function testAndSaveHTML() {
    ...
    try {
        ...
        console.log('- Shows "3 of 3 conditions met":', htmlContent.includes('3/3 conditions met') ? '✅ YES' : '❌ NO');
