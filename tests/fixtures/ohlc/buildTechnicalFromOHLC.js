/**
 * buildTechnicalFromOHLC.js
 * 
 * JavaScript version of the technical indicator builder for OHLC data fixtures
 */
 ...
 */
function calculateSupportResistance(bars) {
  const support = [];
  const resistance = [];
 ...
 */
function buildTechnicalFromOHLC(fixtureData) {
 ...
 */
function createMockTechnicalData(scenario = 'uptrend_highvol') {
